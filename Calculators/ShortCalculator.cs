...
{
	using numberType = System.Int16;
	public struct ShortCalculator : INumberCalculator<numberType>
	{
		public numberType Sum(numberType a, numberType b) => (numberType)(a + b);
		public numberType Add(numberType a, numberType b) => (numberType)(a + b);
		public numberType Divide(numberType a, numberType b) => (numberType)(a / b);
		public numberType Multiply(numberType a, numberType b) => (numberType)(a * b);
		public numberType Subtract(numberType a, numberType b) => (numberType)(a - b);
